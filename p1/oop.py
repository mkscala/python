#!/usr/bin/env python3
#          12 : Lambdas Map, Filter, Reduce and Function Annotations
# https://www.youtube.com/watch?v=1GAC6KQUPeg&list=PLGLfVvz_LVvTn3cK5e6LjhgGiSeVlIRwt&index=12
# http://www.newthinktank.com/2016/07/learn-program-12/
...
#Here's an example of mapping the min function
#  between two lists.
cheapest = map(min, store1, store2)
print("cheapest = ",cheapest)# cheapest =  <map object at 0x01BCC9B0>

for item in cheapest:
    print(item) # 9 11 12.34 2.01
