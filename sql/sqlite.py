#!/usr/bin/env python3
#          19 : sqlite
# https://www.youtube.com/watch?v=yCA5Wzdkfag&index=19&list=PLGLfVvz_LVvTn3cK5e6LjhgGiSeVlIRwt
...
# DELETE 125
# ALTER 142
# PRAGMA 154 Retrieve table column names
# SELECT COUNT(*) FROM Employees 159
import sqlite3
import sys
import csv
...
try:
    sqlstr = "CREATE TABLE Employees("
    sqlstr += "ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"
    sqlstr += "FName TEXT NOT NULL, LName TEXT NOT NULL, Age INT NOT NULL,"
    sqlstr += 'Address TEXT, Salary REAL, HireDate TEXT);'
