#!/usr/bin/env python3
#          22 : TkInter
# https://www.youtube.com/watch?v=-tbWoZSi3LU&list=PLGLfVvz_LVvTn3cK5e6LjhgGiSeVlIRwt&index=20
#   Ttk, Button, Entry, Label, Frame, Checkbutton, TkInter Event
#   Handling, mainLoop(), StringVar, the
#   Pack Geometry Manager, the Grid Geometry Manager

# Must install  python3-tk:
# Files > Settings > Python Interpreter > Clicked on the green "+" at
#  the uppper right >
